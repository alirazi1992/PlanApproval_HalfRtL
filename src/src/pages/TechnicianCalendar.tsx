              ...
              <div className="space-y-2">
                {!selectedCalendarDay ? (
                  ...
                  eventsForSelectedDay.map((event) => (
                    <div
                      key={event.id}
                      className="flex items-center justify-between rounded-2xl border border-gray-100 px-3 py-2 text-right text-sm bg-white"
                    >
                      <div className="text-right">
          ...
          <div className="rounded-2xl border border-dashed border-gray-200 p-3 text-right space-y-3">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              <div>
                ...
                <select
                  className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm bg-white text-right focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="space-y-3">
            {actionItems.length === 0 ? (
              ...
              actionItems.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between border border-gray-100 rounded-2xl px-3 py-2 gap-3"
                >
                  <div className="text-right">
      ...
      {isReportsTab ? (
                          ...
                          >
                            ...
                            <td className="py-3">
                              <select
                                ...
                                dir="rtl"
                                className="w-full border border-gray-200 rounded-xl px-2 py-1 text-xs bg-white text-right focus:outline-none focus:ring-2 focus:ring-blue-500"
                              >
              ...
              <div className="space-y-2">
                {reportChannelFilters
                  ...
                  .map((filter) => (
                    <div
                      key={filter.id}
                      className="rounded-2xl border border-dashed border-gray-200 px-4 py-2 flex items-center justify-between"
                    >
                      <div className="text-right">
                        <p className="text-sm font-medium text-gray-900">
                          کانال {filter.label}
          ...
          <Card className="p-5 space-y-4">
            ...
            <div className="space-y-3">
              {quickStats.map((item) => (
                <div
                  key={item.id}
                  className="rounded-2xl border border-gray-100 bg-white px-4 py-3 flex items-center justify-between flex-row-reverse"
                >
                  <div className="text-right">
        ...
        <section>
          <Card className="p-5 space-y-5">
            ...
            {/* سه ستون – دریافت / میدانی / تحویل (RTL: راست به چپ) */}
            <div className="mt-5 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-3xl bg-slate-900 text-white shadow-lg border border-slate-800 flex flex-col min-h-[280px] relative overflow-hidden">
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800/70">
                  <h4 className="text-sm font-semibold text-right">اجرای میدانی</h4>
                  <div className="flex items-center gap-2 flex-row-reverse">
                  ...
                  {fieldCases.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between text-[10px] text-slate-200/80">
                          <span className="text-right">تکنسین: {item.tech}</span>
                        ...
                        <div className="flex items-center justify-between text-[10px] text-slate-300/80">
                          <span className="opacity-80 text-right">SLA: {item.sla}</span>
...
// Aliases to keep router imports consistent
